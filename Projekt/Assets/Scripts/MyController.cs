...
{	using System;
    ...
    public class MyController : MonoBehaviour
    {
        ...
        private int                 numberOfGameObjectsAllowed = 100;
        //For Pinch to Zoom
        ...
        /*public void Spawn(LeanFinger finger)
        	{
        		if (ARAndroidPrefab != null && finger != null)
        		{
        		TrackableHit hit;
        		...
        		{
        			var ARObject = Instantiate(ARAndroidPrefab, hit.Pose.position, hit.Pose.rotation);
